        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="lapor2.php">Lapor</a></li>
                    <li class="dropdown">
				...
				<div class="row">
					<div class="col-md-12">
						<div class="calltoaction-wrapper">
							<h3>Selamat datang di <span style="color:#aec62c; text-transform:uppercase;font-size:24px;">Ganeshout!</span> Sistem pelaporan fasilitas kampus</h3> <a href="lapor2.php" class="btn btn-orange">Lapor disini!</a>
						</div>
					</div>
				</div>
			</div>
	        	...
	        	<div class="row">
	        		<div class="col-md-4 col-sm-6">
	        			<div class="service-wrapper">
		        			...
		        			<p>Ganeshout mempermudah entiitas kampus dalam melakukan pelaporan fasilitas kampus maupun insiden yang terjadi di kampus secara online</p>
		        			<a href="lapor2.php" class="btn">Lapor</a>
		        		</div>
	        		</div>
	        		<div class="col-md-4 col-sm-6">
	        			<div class="service-wrapper">
